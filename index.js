...
console.log('   ╚═╝    ╚═════╝ ╚═╝  ╚═╝╚══════╝╚═╝  ╚═══╝     ╚═════╝ ╚══════╝╚═╝  ╚═══╝')
console.log(' ')
  console.log('['+'1'.brightBlue+'] Generate');
  ...
  if(choice == 1){
    ...
    console.log("If you need help, contact me Sans#0006 or join my discord server https://dsc.gg/sansserver.")
